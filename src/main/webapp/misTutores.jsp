...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/misTutores" class="getTutores"><i class="fa fa-dashboard fa-fw"></i> Mis Tutores</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div id="titulo" class="col-lg-12">
                    <h1 class="page-header">Mis Tutores</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div id="alumno_id" hidden>${alumnoId}</div>
    ...
    <script src="js/misTutores.js"></script>
